...
- 채광 → 수갑 생산 파이프라인 전체 루프
- 죄수 말풍선 Demand Gauge UI
- 해금존 Plane Fill Image UI
- 튜토리얼 화살표 방향 지시 / 목적지 바운스 모드 전환
- 감옥 가득 참 카메라 연출 + 퍼즈 시퀀스
- 게임 클리어 UI
...
- 사운드 클립 미연동 상태 — 실제 오디오 파일 수급 후 연결 필요
- 죄수 애니메이션 미구현 — 애니메이션 에셋 수급 후 Animator 파라미터 연동 예정
